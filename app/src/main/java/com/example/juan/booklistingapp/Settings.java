...
public class Settings extends AppCompatActivity {
    ...
    public static class BookPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            Preference category = findPreference(getString(R.string.setting_search_by_key));
            bindPreference(category);

            Preference maxbook = findPreference(getString(R.string.settings_resultsNumber_key));
